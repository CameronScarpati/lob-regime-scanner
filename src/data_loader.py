...
# Default: keep one snapshot per 1s — gives ZSCORE_WINDOW=300 a meaningful
# 5-minute rolling window for microstructure signals (OFI, spread dynamics)
# while keeping data tractable (~86k/day).
