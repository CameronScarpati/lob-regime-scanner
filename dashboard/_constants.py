...
PANEL_DESCRIPTIONS = {
    ...
    "diagnostics": (
        ...
        "quoted spread, and cumulative PnL from an illustrative "
        "regime-aware strategy (see the Strategy Performance bar above for "
        "the execution and cost assumptions behind this run). "
